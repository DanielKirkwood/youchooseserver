...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldEmail, user.FieldOtp:
			values[i] = new(sql.NullString)
		case user.FieldCreateTime, user.FieldUpdateTime, user.FieldOtpExpiresAt:
	...
	for i := range columns {
		...
		case user.FieldOtpExpiresAt:
			if value, ok := values[i].(*sql.NullTime); !ok {
				...
				u.OtpExpiresAt = new(time.Time)
				*u.OtpExpiresAt = value.Time
			}
		default:
