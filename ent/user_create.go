...
func (uc *UserCreate) SetOtpExpiresAt(t time.Time) *UserCreate {
	uc.mutation.SetOtpExpiresAt(t)
	return uc
}

// SetNillableOtpExpiresAt sets the "otp_expires_at" field if the given value is not nil.
func (uc *UserCreate) SetNillableOtpExpiresAt(t *time.Time) *UserCreate {
	if t != nil {
		uc.SetOtpExpiresAt(*t)
	}
	return uc
}
